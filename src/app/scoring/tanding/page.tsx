...
export default function ScoringTandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <PageTitle title="Scoring Pertandingan Tanding" description={`Babak ${currentRound} dari ${TOTAL_ROUNDS} - Status: ${matchStatus}`} />
