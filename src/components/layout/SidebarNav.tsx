...
import { Home, CalendarDays, UserCog, BookOpen, ListOrdered, Users, FileSpreadsheet, GitBranch } from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/admin/scheme-management', label: 'Manajemen Skema', icon: GitBranch },
